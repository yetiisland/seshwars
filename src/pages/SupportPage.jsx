    ...
    <div style={{ position: 'fixed', inset: 0, background: '#FDF8F0', zIndex: 999999, display: 'flex', flexDirection: 'column' }}>
      ...
      <div className="scroll-area" style={{ padding: '24px 20px', paddingBottom: 'calc(env(safe-area-inset-bottom) + 60px)' }}>
        <div style={{ maxWidth: 480, margin: '0 auto' }}>
          ...
          <div style={{ fontSize: 10, fontWeight: 700, color: 'var(--text-muted)', textTransform: 'uppercase', letterSpacing: 1.5, marginBottom: 24 }}>
            Support
          </div>

          <div style={{ fontSize: 13, color: 'var(--text-secondary)', lineHeight: 1.7, marginBottom: 20 }}>
            Need help? We're happy to assist. Reach out to us for any of the following:
          </div>
          ...
          {[
            {
              n: '1',
              title: 'GENERAL HELP',
              body: 'Questions about how the app works, account issues, or anything else — email us and we\'ll get back to you.',
            },
            {
              n: '2',
              title: 'BUG REPORTS',
              body: 'Found something broken? Let us know what happened and we\'ll look into it.',
            },
            {
              n: '3',
              title: 'SPOT REMOVAL REQUESTS',
              body: 'If you are a property owner or representative and would like a spot removed, contact us with the spot name and location and we will remove it promptly.',
            },
            {
              n: '4',
              title: 'CONTACT',
              body: 'taylor@yetiisland.studio',
            },
          ].map(section => (
